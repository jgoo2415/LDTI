...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Simulation Example Code for time-invariant curves
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for ind=1:nt
    y_array{ind,1}=init_template1b(nx,ny,nz,B);  % generate the response vector
...
for ind=1:nt
    plot3(xnhat{ind}(1,:),xnhat{ind}(2,:),xnhat{ind}(3,:),'b') % To make a graph of estimated curves over time 
    hold on
end
...
chi_null_svd=zeros(1,3); % To save the test statistic value under H0
...
for rep=1:3
    ...
    chi_null_svd(1,rep)=diff'*pinv(U*S*V')*diff; % the observed value of the test statistic 
end 
